    ...
    return (
        <div className="min-h-screen bg-polka flex items-center justify-center p-6">
            <div className="bg-white p-12 cartoon-border cartoon-shadow rounded-3xl max-w-xl text-center space-y-6">
                ...
                <h1 className="text-5xl font-[family-name:var(--font-bangers)] text-primary">გადახდა გაუქმდა</h1>
                <p className="text-xl font-medium">გადახდის პროცესი არ დასრულებულა. თუ რაიმე პრობლემა შეგექმნათ, დაგვიკავშირდით.</p>
